...
#define CR_EVENT_CLASS_TYPE(eventType) static Car::Event::Type getStaticType() { return Type::eventType; }\
...
#define CR_EVENT_CLASS_CATEGORY(category) virtual uint32_t getCategoryFlags() const override { return category; }
